...
const Navbar = () => {
  ...
  return (
    ...
    <nav className={`w-full fixed px-5 lg:px-8 xl:px-[8%] py-4 flex items-center justify-between z-50 ${isScroll ? "bg-white/60 supports-[backdrop-filter]:bg-white/50 backdrop-blur-lg shadow-sm " : "bg-transparent"}`}>
        <a href="#top">
